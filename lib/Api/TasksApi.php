...
class TasksApi
{
     ...
     */
    public function tasksGet($page = null, $per_page = null)
    {
        list($response) = $this->tasksGetWithHttpInfo($page, $per_page);
        return $response;
    }
     ...
     */
    public function tasksGetWithHttpInfo($page = null, $per_page = null)
    {
        $returnType = '\Swagger\Client\Model\CbrainTask[]';
        $request = $this->tasksGetRequest($page, $per_page);
     ...
     */
    public function tasksGetAsync($page = null, $per_page = null)
    {
        return $this->tasksGetAsyncWithHttpInfo($page, $per_page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tasksGetAsyncWithHttpInfo($page = null, $per_page = null)
    {
        $returnType = '\Swagger\Client\Model\CbrainTask[]';
        $request = $this->tasksGetRequest($page, $per_page);
     ...
     */
    protected function tasksGetRequest($page = null, $per_page = null)
    {
    ...
    protected function tasksPostRequest($cbrain_task)
    {
        ...
        if ($cbrain_task === null || (is_array($cbrain_task) && count($cbrain_task) === 0)) {
            throw new \InvalidArgumentException(
