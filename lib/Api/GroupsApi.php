...
class GroupsApi
{
     ...
     */
    public function groupsGet($page = null, $per_page = null)
    {
        list($response) = $this->groupsGetWithHttpInfo($page, $per_page);
        return $response;
    }
     ...
     */
    public function groupsGetWithHttpInfo($page = null, $per_page = null)
    {
        $returnType = '\Swagger\Client\Model\Group[]';
        $request = $this->groupsGetRequest($page, $per_page);
     ...
     */
    public function groupsGetAsync($page = null, $per_page = null)
    {
        return $this->groupsGetAsyncWithHttpInfo($page, $per_page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function groupsGetAsyncWithHttpInfo($page = null, $per_page = null)
    {
        $returnType = '\Swagger\Client\Model\Group[]';
        $request = $this->groupsGetRequest($page, $per_page);
     ...
     */
    protected function groupsGetRequest($page = null, $per_page = null)
    {
    ...
    protected function groupsIdPutRequest($id, $group_mod_req)
    {
        ...
        if ($group_mod_req === null || (is_array($group_mod_req) && count($group_mod_req) === 0)) {
            throw new \InvalidArgumentException(
